...
<Stack gap="away">
	...
	>
		...
		<Alert intent="info">
			...
			<a href="/theming/overview">Theming Overview</a> for the tier model.
		</Alert>
		<p>
	...
	>
		...
		<p>
			For structure, reach for the layout components (<a href="/components/stack">Stack</a>,
			<a href="/components/grid">Grid</a>, <a href="/components/cluster">Cluster</a>) or the
			<a href="/foundation/utilities">utility sheet</a> where they fit — then use Tailwind utilities for
			the one-off nudges on top.
		</p>
	</Stack>
	...
	>
		...
		<p>
			See <a href="/theming/tokens">Tokens &amp; Overrides</a> for the full token surface and how to override
			it.
		</p>
	</Stack>
</Stack>
