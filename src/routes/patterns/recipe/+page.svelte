...
<Stack gap="xl">
	<div>
		<h1>Recipe</h1>
		<p class="lead">
			A recipe page: the ingredient list is a plain, non-sorting <a href="/components/table"
				>Table</a
			>
			(no <code>sortable</code> column flag, no sort buttons — the same shape as the Table docs
			page's own "No sorting" demo), the method is step-by-step prose with photos along the way, and
			a short technique <a href="/components/video">Video</a> closes it out. Spacing between the
			major sections uses the density system's <code>gap="away"</code>; the ingredients heading and
			its table sit closer together on <code>gap="near"</code>.
		</p>
		<p class="composed">
			Composes
	...
	<section aria-labelledby="source-heading">
		...
		<CodeBlock code={consumerSource(recipeSource)} />
	</section>
</Stack>
