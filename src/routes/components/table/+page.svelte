...
<DocPage
	name="Table"
	description="A data table with client sorting, row selection, a sticky header, built-in empty/loading states, and an opt-in stacked mode for narrow widths. Real <table> semantics throughout."
	importLine={'import {Table} from "@hyzer-labs/ui"'}
	{props}
	types={[
		{ name: 'TableColumn<T>', props: columnType },
		{ name: 'TableSort', props: sortType }
	]}
