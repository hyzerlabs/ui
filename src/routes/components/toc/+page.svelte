<script lang="ts">
	...
	const tocEntryType: PropRow[] = [
		...
		{ name: 'label', type: 'string', default: '—', note: "The heading's trimmed text content." },
		{ name: 'level', type: 'number', default: '—', note: 'The collected heading level (2, 3, …).' }
	];
...
<DocPage
	name="Toc"
	description="A navigation rail: automatic heading collection, nested levels, scroll-spy, smooth scroll, and an optional mobile collapse — the docs site's own 'On this page' rail (R9), generalized behind props."
	importLine={'import {Toc} from "@hyzer-labs/ui"'}
	{props}
	types={[{ name: 'TocEntry', props: tocEntryType }]}
