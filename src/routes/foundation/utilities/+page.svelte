	...
	>
		...
		<ul class="js-utils-list">
			<li>
				...
				functions behind the <a href="/foundation/contrast#checker-heading">pairing checker</a>. See
				<a href="/theming/tokens#verify-heading">Verify your palette</a> for using them in a unit test.
			</li>
			<li>
