...
<section class="doc-section" aria-labelledby="vocabulary-heading">
	...
	<p>
		...
		<a href="/docs/components/popover">Popover</a> take the full set, all eight placements, as a
		<code>placement</code> prop. <a href="/docs/components/dropdown">Dropdown</a>'s menu only
		exposes
...
<section class="doc-section" aria-labelledby="toplayer-heading">
	...
	<p>
		...
		stacks above whom — their tiers are ordered so that fallback matches what the top layer gives you
		for free.
	</p>
	<p>
...
<section class="doc-section" aria-labelledby="caret-heading">
	...
	<p>
		...
		own scrollbar. On <a href="/docs/components/popover">Popover</a> specifically, draw the caret on
